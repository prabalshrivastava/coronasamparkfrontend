...
@Component
public class GoogleContactsUtil {
    ...
    public void setUp() throws IOException {
        ...
        String clientId = appConstants.getClientId();
        String clientSecret = appConstants.getClientSecret();

        // Or your redirect URL for web based applications.
        String redirectUrl = "http://localhost:8089/";
